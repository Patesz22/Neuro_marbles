...
* **A rewrite of [neuro-sdk-websocketpp](https://github.com/chris-pie/neuro-sdk-websocketpp) by chris-pie** using IXWebSocket for support of newer OpenSSL versions
